...
<header>
    ...
    <section>
        ...
        <table border="1" class="tabProducts" >
            <tr>
                <th>Id</th>
                <th>Imagem</th>
                <th>Título</th>
            ...
            <?php
                while($products_data = mysqli_fetch_assoc($result)){
                    ...
                    echo "<td style='height:75px; width:75px'>" .$products_data['product_image']. "</td>"; 
                    echo "<td>" .$products_data['product_name']. "</td>";                   
                    echo "<td>" .$products_data['product_description']. "</td>"; 
                    echo "<td>
                    <a class='btn btn-sm btn-primary' href='delete.php?id=$products_data[product_id]'>
                ...
                // DESCRIÇÃO FAZER UMA FUNCÇÃO PARA APARECER TEXTO COMPLETO
            ?>
        </table>
    </section>
